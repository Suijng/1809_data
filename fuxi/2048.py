...
class Frame(easy_2048.Frame):
    def __init__(self, title):
        ...
        super(Frame, self).__init__(None, -1, title,
                                    style=easy_2048.DEFAULT_FRAME_STYLE ^ easy_2048.MAXIMIZE_BOX ^ easy_2048.RESIZE_BORDER)
        ...
        panel = easy_2048.Panel(self)
        panel.Bind(easy_2048.EVT_KEY_DOWN, self.onKeyDown)
        panel.SetFocus()
        self.initBuffer()
        self.Bind(easy_2048.EVT_SIZE, self.onSize)
        self.Bind(easy_2048.EVT_PAINT, self.onPaint)
        self.Bind(easy_2048.EVT_CLOSE, self.onClose)
    ...
    def onPaint(self, event):
        dc = easy_2048.BufferedPaintDC(self, self.buffer)
    ...
    def setIcon(self):
        icon = easy_2048.Icon("icon.ico", easy_2048.BITMAP_TYPE_ICO)
        self.SetIcon(icon)
    ...
    def initGame(self):
        self.bgFont = easy_2048.Font(50, easy_2048.SWISS, easy_2048.NORMAL, easy_2048.BOLD, face=u"Roboto")
        self.scFont = easy_2048.Font(36, easy_2048.SWISS, easy_2048.NORMAL, easy_2048.BOLD, face=u"Roboto")
        self.smFont = easy_2048.Font(12, easy_2048.SWISS, easy_2048.NORMAL, easy_2048.NORMAL, face=u"Roboto")
        self.curScore = 0
        self.bstScore = 0
        self.loadScore()
    ...
    def initBuffer(self):
        ...
        self.buffer = easy_2048.EmptyBitmap(w, h)
    ...
    def doMove(self, move, score):
        ...
        if move:
            ...
            if self.isGameOver():
                if easy_2048.MessageBox(u"游戏结束，是否重新开始？", u"哈哈",
                                 easy_2048.YES_NO | easy_2048.ICON_INFORMATION) == easy_2048.YES:
    ...
    def onKeyDown(self, event):
        ...
        if keyCode == easy_2048.easy_2048K_UP:
            self.doMove(*self.slideUpDown(True))
        elif keyCode == easy_2048.easy_2048K_DOWN:
            self.doMove(*self.slideUpDown(False))
        elif keyCode == easy_2048.easy_2048K_LEFT:
            self.doMove(*self.slideLeftRight(True))
        elif keyCode == easy_2048.easy_2048K_RIGHT:
            self.doMove(*self.slideLeftRight(False))

            # Creates background for the game board

    def drawBg(self, dc):
        dc.SetBackground(easy_2048.Brush((250, 248, 239)))
        dc.Clear()
        dc.SetBrush(easy_2048.Brush((187, 173, 160)))
        dc.SetPen(easy_2048.Pen((187, 173, 160)))
        ...
        for row in range(4):
            for col in range(4):
                ...
                if value == 2 or value == 4:
                    ...
                    dc.SetTextForeground((255, 255, 255))
                dc.SetBrush(easy_2048.Brush(color))
                dc.SetPen(easy_2048.Pen(color))
                ...
                while size[0] > 100 - 15 * 2:  # changes font size based on number within tile
                    self.scFont = easy_2048.Font(self.scFont.GetPointSize() * 4 / 5, easy_2048.SWISS, easy_2048.NORMAL, easy_2048.BOLD,
                                          face=u"Roboto")
                    dc.SetFont(self.scFont)
                    size = dc.GetTextExtent(str(value))
    ...
    def drawAll(self):
        dc = easy_2048.BufferedDC(easy_2048.ClientDC(self), self.buffer)
        self.drawBg(dc)
        self.drawLogo(dc)
        self.drawLabel(dc)
        self.drawScore(dc)
