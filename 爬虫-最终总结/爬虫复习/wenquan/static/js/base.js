...
function prompt_frm(txt, type, s, isTop, opa) {
    ...
    if (type == 0) {
        $('.prompt_frm').attr('css', 'prompt_frm');
    }
    if (type == 1) {
        $('.prompt_frm').addClass('prompt_frm_1');
    }
    if (type == 2) {
        $('.prompt_frm').addClass('prompt_frm_2');
    }
    if (type == 3) {
        $('.prompt_frm').addClass('prompt_frm_3');
    }
    if (type == 4) {
        $('.prompt_frm').addClass('prompt_frm_4');
    }
    if (s != 0) {
        prompt_timer = setTimeout(function () {
            $('.prompt_frm').hide();
            $('#promptBG').remove();
        }, s)
    }
...
$(function () {
    ...
    $('.shop_guide_list li').hover(function () {
        ...
        guideTime = setTimeout(function () {
            ...
            if (l > 490) {
                cla.addClass('rightS');
                cla.find('.img_store').css('border-left-color', '#fff');
            }
            else {
                cla.removeClass('rightS');
                cla.find('.img_store').css('border-right-color', '#fff');
            }
