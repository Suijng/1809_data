                ...
                for item in result:
                    ...
                    try:
                        ...
                        if 'tb_counter' in html:
                            ...
                            print(nums, self.row)
                            # #关注量
                            item_dict['guanzhu_nums'] = int(nums[0])
                            self.sheet.cell(self.row, 9).value = item_dict['guanzhu_nums']
                            item_dict['fensi_nums'] = int(nums[1])
                            self.sheet.cell(self.row, 10).value = item_dict['fensi_nums']
                            item_dict['weibo_nums'] = int(nums[2])
                            self.sheet.cell(self.row, 11).value = item_dict['weibo_nums']
